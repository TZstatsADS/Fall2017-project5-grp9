...
a_row3 = c("Random Forest - cross validated with the best mtry", "ntree = 25", 177.6382)
a_row4 = c("XGBoost - cross validated with different params", NA, NA)
...
s_row3 = c("Random Forest - cross validated with the best mtry", "ntree = 36", 0.940625)
s_row4 = c("XGBoost - cross validated with different params", "nrounds=200, max_depth=3, eta=0.1, gamma=1, colsample_bytree=0.9, min_child_weight=1, subsample=0.5", 0.9421875)
...
c_row3 = c("Random Forest - cross validated with the best mtry", "ntree = 165", 0.2109375)
c_row4 = c("XGBoost - cross validated with different params", "nrounds=100, max_depth=3, eta=0.1, gamma=1, colsample_bytree=0.7, min_child_weight=1, subsample=0.5", 0.1953125)
c_row5 = c("Multinomial logistic regression", "MaxNWts = 140000, maxit = 1000", 0.1890625)

country_result = data.frame(rbind(c_row1,c_row2,c_row3,c_row4,c_row5))
